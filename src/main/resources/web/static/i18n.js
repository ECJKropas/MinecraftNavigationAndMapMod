...
const I18N = {
  ...
  translations: {
    'zh-CN': {
      ...
      'editor.segment.direction': '方向',
      'editor.segment.direction.bidirectional': '双向',
      'editor.segment.direction.forward': '起点→终点',
      'editor.segment.direction.backward': '终点→起点',
    ...
    'en': {
      ...
      'editor.segment.direction': 'Direction',
      'editor.segment.direction.bidirectional': 'Bidirectional',
      'editor.segment.direction.forward': 'Start→End',
      'editor.segment.direction.backward': 'End→Start',
