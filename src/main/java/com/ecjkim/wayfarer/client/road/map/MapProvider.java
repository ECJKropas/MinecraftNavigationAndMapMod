 ...
 * tileX = floor(worldX / 256), tileY = floor(worldZ / 256),
 * pixelX = worldX % 256, pixelY = worldZ % 256.
 * Each tile covers 256x256 blocks and is returned as a 256x256 ARGB image.
 */
